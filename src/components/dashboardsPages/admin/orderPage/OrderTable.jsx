...
const OrderTable = ({ orders = [], onRowClick }) => {
  ...
  const styles = {
    container: {
      ...
      // REMOVED overflow: "hidden" here to fix the dropdown clipping
      position: "relative", 
      minHeight: "400px" // Ensures minimum height so dropdowns don't look squashed
    },
    header: {
      padding: "20px 24px",
    ...
    tableWrapper: { 
      width: "100%", 
      overflowX: "auto",
      // Allow vertical overflow so the menu pops out
      overflowY: "visible", 
      paddingBottom: "100px" // Extra space at bottom to ensure last row menu is visible
    },
    ...
    statusBadge: (style) => ({
      background: style.bg, color: style.text, padding: "4px 12px",
      borderRadius: "20px", fontSize: "12px", fontWeight: "600",
      display: "inline-flex", alignItems: "center", gap: "6px",
      border: `1px solid ${style.bg}` // Added subtle border
    }),
    ...
    dropdown: {
      position: "absolute", 
      right: "0px", // Aligned to right edge of button
      top: "100%", // Pushes it directly below button
      marginTop: "4px",
      width: "160px",
      background: "white", 
      borderRadius: "8px",
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <h3 style={{ margin: 0, fontSize: "18px", fontWeight: "600", color: "#1e293b" }}>Latest Orders</h3>
        ...
        <table style={styles.table}>
          <thead style={styles.thead}>
            <tr>
              ...
              <th style={{ ...styles.th, textAlign: "right", width: "60px" }}>Action</th>
            </tr>
          </thead>
          <tbody ref={menuRef}>
            {orders.map((order, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={styles.td}>
                    <div style={{ fontWeight: "500", color: "#1e293b" }}>{order.customerName}</div>
                  </td>
                  ...
                  <td style={styles.td}>
                    <div style={{ fontWeight: "600", color: "#1e293b" }}>₹{order.totalAmount}</div>
                  </td>
                    ...
                    <div style={styles.menuContainer}>
                      ...
                      {isMenuOpen && (
                        <div style={styles.dropdown}>
                          <div
                            onClick={() => { setActiveMenuId(null); onRowClick(order); }}
