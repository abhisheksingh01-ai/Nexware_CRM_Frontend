      ...
      {filteredLeads.map((lead) => (
        ...
        >
          ...
          <div className="flex justify-between items-start mb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="overflow-hidden">
                <h3 className="font-semibold text-slate-900 truncate max-w-[140px]" title={lead.name}>
                  {lead.name}
                </h3>
            ...
            <div className="relative">
              <button
                ...
                className={`p-1.5 rounded-lg transition-colors ${
                    openMenuId === lead._id ? "bg-slate-100 text-slate-900" : "text-slate-400 hover:text-slate-700 hover:bg-slate-50"
                }`}
              >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {lead.address && (
              <span className="text-[11px] text-slate-400 flex items-center gap-1 max-w-[100px] truncate" title={lead.address}>
          ...
          <div className="grid grid-cols-2 gap-4 mb-5 p-3 bg-slate-50 rounded-lg border border-slate-100/50">
            <div>
              <p className="text-[10px] uppercase tracking-wider text-slate-400 font-bold mb-0.5">Source</p>
              <p className="text-sm font-semibold text-slate-700 truncate">{lead.source}</p>
            </div>
            <div>
              <p className="text-[10px] uppercase tracking-wider text-slate-400 font-bold mb-0.5">Assigned To</p>
